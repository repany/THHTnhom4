...
class User
  ...
  field :dld, type: Integer
  field :hld, type: Integer
  field :triglycerides, type: Integer
  field :sleep, type: Integer
  field :exercise, type: Integer
  field :happiness, type: Integer
  field :glucose, type: Integer
  field :blood_pressure_systolic, type: Integer
  field :blood_pressure_diastolic, type: Integer
  field :alcohol, type: Integer
  field :smoking, type: Integer
  field :waist_circumference, type: Integer
